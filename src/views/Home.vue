    ...
    <div class="flex flex-col items-center justify-center w-full h-full">
      <div class="flex flex-col justify-center items-center h-screen">
        ...
        <div class="flex">
          ...
          <svg
            v-show="renderWinnerLoad"
            class="animate-spin ml-6 mt-9 mr-3 h-10 w-10 text-white"
        ...
        <div class="flex-col">
          <button
            ...
            class="
              ...
              md:mr-10
              border-green
              hover:border-white hover:bg-green hover:bg-opacity-10
              mt-14
              text-green
              hover:text-white
              w-36
